...
function toggleMenu() {
  ...
  if (menuShown) {
    ...
    menuimg.src = "images/luk.svg"; // sæt btn.textContent til "Luk", hvis menuShown er "true"
  } else {
    console.log(menuShown); // se i konsollen
    menuimg.src = "images/burgermenu.svg"; // sæt btn.textContent til "Menu", hvis menuShown er "false"
  }
